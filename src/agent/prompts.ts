...
- Route what you learn to the right place. Facts about the user and pointers into their vault go here. How a kind of task is done, the pitfalls you hit doing it, and the user's corrections about that work belong in the skill you used for it (revise it with manage_skills), where they load only when relevant. Nothing that only mattered in this conversation is written anywhere.
